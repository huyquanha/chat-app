...
type ChatServiceClient interface {
	...
	SendMessage(context.Context, *connect.Request[SendMessageRequest]) (*connect.Response[SendMessageResponse], error)
	// stream messages from a room in real time
	Subscribe(context.Context, *connect.Request[SubscribeRequest]) (*connect.ServerStreamForClient[SubscribeResponse], error)
}
...
func NewChatServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ChatServiceClient {
	...
	return &chatServiceClient{
		sendMessage: connect.NewClient[SendMessageRequest, SendMessageResponse](
			httpClient,
		...
		subscribe: connect.NewClient[SubscribeRequest, SubscribeResponse](
			httpClient,
...
type chatServiceClient struct {
	sendMessage *connect.Client[SendMessageRequest, SendMessageResponse]
	subscribe   *connect.Client[SubscribeRequest, SubscribeResponse]
}

// SendMessage calls chat.v1.ChatService.SendMessage.
func (c *chatServiceClient) SendMessage(ctx context.Context, req *connect.Request[SendMessageRequest]) (*connect.Response[SendMessageResponse], error) {
	return c.sendMessage.CallUnary(ctx, req)
}

// Subscribe calls chat.v1.ChatService.Subscribe.
func (c *chatServiceClient) Subscribe(ctx context.Context, req *connect.Request[SubscribeRequest]) (*connect.ServerStreamForClient[SubscribeResponse], error) {
...
type ChatServiceHandler interface {
	...
	SendMessage(context.Context, *connect.Request[SendMessageRequest]) (*connect.Response[SendMessageResponse], error)
	// stream messages from a room in real time
	Subscribe(context.Context, *connect.Request[SubscribeRequest], *connect.ServerStream[SubscribeResponse]) error
}
...
func (UnimplementedChatServiceHandler) SendMessage(context.Context, *connect.Request[SendMessageRequest]) (*connect.Response[SendMessageResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chat.v1.ChatService.SendMessage is not implemented"))
}

func (UnimplementedChatServiceHandler) Subscribe(context.Context, *connect.Request[SubscribeRequest], *connect.ServerStream[SubscribeResponse]) error {
