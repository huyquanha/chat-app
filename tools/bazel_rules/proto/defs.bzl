"""Copy proto-generated files to the source tree."""
...
def write_go_generated_source_files(name, src, output_files, **kwargs):
    ...
    Args:
      ...
      src: The go_proto_library target to copy the generated files from.
      output_files: The file names to be coppied.
